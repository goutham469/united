  ...
  return (
    <div className='w-46 p-2 bg-white rounded'>
        ...
        <div className='grid grid-cols-3 gap-3 py-2'>
          <button onClick={()=>addToDeals()} className='border px-1 py-1 text-sm border-green-600 bg-green-100 text-green-800 hover:bg-green-200 rounded'>Add to Deals</button>
